...
const file_chat_chat_proto_rawDesc = "" +
	...
	"\vChatService\x126\n" +
	"\vSendMassage\x12\x11.chat.ChatMassage\x1a\x12.chat.ChatResponse(\x01\x12@\n" +
	"\x0eReceiveMessage\x12\x1b.chat.ReceiveMessageRequest\x1a\x11.chat.ChatMassage\x120\n" +
